...
import {
    ...
    World,
    Entity,
    Component, // Used as a type constraint for component classes
...
const rightHandSlot = (player.components['equipmentSlot'] as any)?.['rightHand'] as EquipmentSlot | undefined;
if (rightHandSlot) {
...
const humanEntity: Entity | undefined = world.createPrefab('Human'); // Use 'Human', not 'HumanPrefab'
if (humanEntity) {
